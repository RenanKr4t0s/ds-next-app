                ...
                <div className='row justify-content-center'>
                    <div className='col-lg-5 col-12 m-3'>
                        <div className='custom_simple-box rounded'>
                            ...
                            Bem-vindos à nossa floricultura!<br/> Somos uma empresa familiar tradicional, fundada e gerida com amor pela dona Dalva e sua querida família.<br/> Há mais de três décadas, temos o prazer de trazer flores eternas, presentes encantadores e lembranças especiais para os nossos queridos clientes da região do Taboão.
                            </p>
                        </div>
                    ...
                    <div className='col-lg-5 col-12 custom_simple-box rounded m-3'>
                        ...
                        Aqui, você não encontra apenas flores, mas também um pedacinho da nossa história e do nosso coração.<br/> Venha nos visitar e deixe-nos fazer parte dos seus momentos especiais, transformando cada ocasião em uma lembrança inesquecível.<br/>
                        Com carinho,<br/>
                        Dona Dalva e Família<br/>
                        </p>
                    </div>
                </div>
            </div>
